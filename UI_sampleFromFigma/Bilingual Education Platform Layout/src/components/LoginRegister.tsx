        ...
        <div className="max-w-xl">
          ...
          >
            <h2 className="mb-4 text-foreground">
              {t('Connect Teachers, Parents & Schools', 'Kết nối Giáo viên, Phụ huynh & Trường học')}
            </h2>
              ...
              <TabsContent value="register">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select required>
                      <SelectTrigger id="register-role" className="rounded-xl">
                        <SelectValue placeholder={t('Select role', 'Chọn vai trò')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="parent">{t('Parent', 'Phụ huynh')}</SelectItem>
                        <SelectItem value="student">{t('Student', 'Học sinh')}</SelectItem>
                        <SelectItem value="teacher">{t('Teacher', 'Giáo viên')}</SelectItem>
                        <SelectItem value="admin">{t('School Admin', 'Quản trị trường')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
