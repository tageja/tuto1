...
import { getFollowersProfiles } from '../../services/social/follows.service';
...
type RouteProps = RouteProp<SocialStackParamList, 'Followers'>;
...
export default function FollowersScreen() {
  ...
  const title = `${profiles.length} ${t('community.followers.title') as string}`;
