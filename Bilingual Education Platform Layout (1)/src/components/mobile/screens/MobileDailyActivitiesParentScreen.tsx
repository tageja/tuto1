...
export function MobileDailyActivitiesParentScreen() {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-[#F9FAFC] dark:bg-gray-900">
        ...
        <div className="flex items-center justify-between mb-1">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {t("Track your child's daily activities and progress", "Theo dõi hoạt động và tiến độ của con")}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {t(
              "There are no daily activities recorded for your child yet. Activities will appear here once teachers start tracking them.",
              "Chưa có hoạt động nào được ghi nhận cho con bạn. Các hoạt động sẽ xuất hiện ở đây khi giáo viên bắt đầu theo dõi."
            )}
          </p>
        </div>
