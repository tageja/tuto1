...
export function MobileDashboardLayout({
  ...
  const menuItems = [
    ...
    {
      id: "activities",
      label: t("Daily Activities", "Hoạt động"),
      icon: ClipboardList,
    },
    {
      id: "messages",
              ...
              <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                {onRoleToggle && (
                  ...
                  >
                    ...
                    {t(
                      `Switch to ${userRole === "admin" ? "Parent" : "Admin"} View`,
                      `Chuyển sang chế độ ${userRole === "admin" ? "Phụ huynh" : "Quản trị"}`
                    )}
                  </Button>
                )}
              </div>
