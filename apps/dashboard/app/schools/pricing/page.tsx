    ...
    <div className="min-h-screen bg-gradient-to-br from-surface via-white to-blue-50/30">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            href="/school"
            className="px-5 py-2.5 bg-primary text-white rounded-full text-sm font-bold hover:bg-primary/90 transition-colors shadow-md"
          >
      ...
      <footer className="bg-gray-50 border-t border-gray-100 py-8 mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center text-gray-500 text-sm">
          © 2026 tuto. Education. {isVi ? "Bảo lưu mọi quyền." : "All rights reserved."}
        </div>
      </footer>
    </div>
  );
