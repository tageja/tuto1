        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-text mb-2">
                  {lang === 'vi' ? 'Tên lớp' : 'Class Name'} <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  name="className"
                  ...
                  className="w-full px-4 py-2 border border-border bg-card text-text rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/40"
                />
              ...
              <div>
                <label className="block text-sm font-medium text-text mb-2">
                  {lang === 'vi' ? 'Khối' : 'Grade Level'} <span className="text-danger">*</span>
                </label>
                <select
                  name="grade"
                  required
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-text mb-2">
                  {lang === 'vi' ? 'Sức chứa' : 'Capacity'} <span className="text-danger">*</span>
                </label>
                <input
                  type="number"
                  name="capacity"
              ...
              <div className="md:col-span-2">
                ...
                {loadingTeachers ? (
                  <div className="w-full px-4 py-2 border border-border rounded-lg bg-surface">
