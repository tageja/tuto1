...
import { TeacherSidebar } from '../../../../components/school/TeacherSidebar';
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-56 bg-card rounded-lg shadow-lg border border-border py-2 z-50">
                    ...
                    <button
                      onClick={() => {
                        setShowUserMenu(false);
                        router.push(`/school/${encodeURIComponent(schoolId)}/teacher/settings`);
                      }}
                    ...
                    <button
                      onClick={() => {
                        setShowUserMenu(false);
                        router.push(`/school/${encodeURIComponent(schoolId)}/teacher/settings?tab=profile`);
                      }}
                      className="w-full flex items-center gap-3 px-4 py-2 text-sm text-text hover:bg-surface transition-colors"
                    >
