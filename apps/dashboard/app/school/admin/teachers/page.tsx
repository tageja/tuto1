 ...
 * This page redirects /school/admin/teachers to /school/[schoolId]/admin/teachers
 */
export default function TeachersPageRedirect() {
  ...
  useEffect(() => {
    ...
    router.replace(`/school/${encodedSchoolId}/admin/teachers`);
