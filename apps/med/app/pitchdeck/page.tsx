...
export const metadata: Metadata = {
  title: 'Pitch Deck — NurseEd by Tuto',
  description: 'Investor and partner pitch deck for NurseEd, the medical English upskill platform for Vietnamese nurses.',
}
    ...
    <div className="min-h-screen bg-[#0f0f13] flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#0f0f13]/90 backdrop-blur sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-semibold text-sm leading-tight">NurseEd Pitch Deck</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="/pitchdeck.pdf"
            download="NurseEd_PitchDeck.pdf"
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="md:hidden flex flex-1 items-center justify-center p-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 max-w-sm w-full text-center">
            ...
            <h2 className="text-white font-bold text-xl mb-2">NurseEd Pitch Deck</h2>
