...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* CTA */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-[var(--primary)] to-blue-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">{t.ctaReadySubtitle}</p>
          <Link
            href="/learn"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[var(--primary)] rounded-xl font-semibold text-lg hover:bg-blue-50 transition-all hover:scale-105 shadow-xl"
          >
