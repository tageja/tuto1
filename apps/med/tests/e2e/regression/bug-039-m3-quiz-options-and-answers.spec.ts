/**
 * Minor — M3 `quiz` steps: MCQ hygiene (≥2 options, answer id matches option, trims).
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-039-m3-quiz-options-and-answers'));
...
test.describe('Bug #039 — M3 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module3, TAG.content, TAG.data, bugTag(39)],
}, () => {
