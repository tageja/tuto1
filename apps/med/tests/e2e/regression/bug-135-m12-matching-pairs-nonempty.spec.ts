/**
 * Bug #135 — M12 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-135-m12-matching-pairs-nonempty'));

test.describe('Bug #135 — M12 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module12, TAG.content, TAG.data, bugTag(135)],
}, () => {
