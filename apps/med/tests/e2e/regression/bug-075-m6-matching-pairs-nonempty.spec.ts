/**
 * Bug #075 — M6 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-075-m6-matching-pairs-nonempty'));

test.describe('Bug #075 — M6 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module6, TAG.content, TAG.data, bugTag(75)],
}, () => {
