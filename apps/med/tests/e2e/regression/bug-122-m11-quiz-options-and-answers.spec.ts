/**
 * Bug #122 — M11 `quiz` MCQ structure (L1–L3; L4 has no quiz — in-progress lesson).
 */
...
test.describe('Bug #122 — M11 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module11, TAG.content, TAG.data, bugTag(122)],
}, () => {
