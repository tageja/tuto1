/**
 * Bug #062 — M5 `matching` pairs: non-empty `left_en` + `right_vi` (aliases accepted).
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-062-m5-matching-pairs-nonempty'));

test.describe('Bug #062 — M5 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module5, TAG.content, TAG.data, bugTag(62)],
}, () => {
