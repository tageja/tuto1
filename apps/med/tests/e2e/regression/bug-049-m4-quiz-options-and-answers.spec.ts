/**
 * Bug #049 — M4 `quiz` steps: MCQ hygiene.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-049-m4-quiz-options-and-answers'));
...
test.describe('Bug #049 — M4 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module4, TAG.content, TAG.data, bugTag(49)],
}, () => {
