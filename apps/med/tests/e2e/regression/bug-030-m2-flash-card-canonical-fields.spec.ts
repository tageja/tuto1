/**
 * Minor — M2 `flash_card` steps: canonical `front_en` / `back_vi` (no legacy-only cards),
 * no blank faces.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-030-m2-flash-card-canonical-fields'));

test.describe('Bug #030 — M2 flash cards use front_en + back_vi', {
  tag: [TAG.regression, TAG.module2, TAG.content, TAG.data, bugTag(30)],
}, () => {
