/**
 * Bug #084 — M7 `audio_shadow` transcript + transcriptSegments with `vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-084-m7-audio-shadow-transcripts'));

test.describe('Bug #084 — M7 audio_shadow transcript + segments', {
  tag: [TAG.regression, TAG.module7, TAG.content, TAG.data, bugTag(84)],
}, () => {
