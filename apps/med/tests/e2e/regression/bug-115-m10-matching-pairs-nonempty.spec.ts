/**
 * Bug #115 — M10 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-115-m10-matching-pairs-nonempty'));

test.describe('Bug #115 — M10 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module10, TAG.content, TAG.data, bugTag(115)],
}, () => {
