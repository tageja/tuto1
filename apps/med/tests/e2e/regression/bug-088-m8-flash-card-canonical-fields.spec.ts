/**
 * Bug #088 — M8 `flash_card`: canonical `front_en` / `back_vi` / `audio_en`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-088-m8-flash-card-canonical-fields'));

test.describe('Bug #088 — M8 flash cards use front_en + back_vi', {
  tag: [TAG.regression, TAG.module8, TAG.content, TAG.data, bugTag(88)],
}, () => {
