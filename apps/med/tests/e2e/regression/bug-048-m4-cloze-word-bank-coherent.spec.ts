/**
 * Bug #048 — M4 (`common-emergency-scenarios`) `cloze` steps: bracket blanks + word bank.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-048-m4-cloze-word-bank-coherent'));

test.describe('Bug #048 — M4 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module4, TAG.content, TAG.data, bugTag(48)],
}, () => {
