/**
 * Bug #111 — M10 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m10-emergency-procedures-communication-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-111-m10-cloze-word-bank-coherent'));

test.describe('Bug #111 — M10 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module10, TAG.content, TAG.data, bugTag(111)],
}, () => {
