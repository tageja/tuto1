/**
 * Bug #131 — M12 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m12-family-communication-emergencies-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-131-m12-cloze-word-bank-coherent'));

test.describe('Bug #131 — M12 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module12, TAG.content, TAG.data, bugTag(131)],
}, () => {
