/**
 * Bug #118 — M11 `flash_card`: canonical `front_en` / `back_vi` / `audio_en`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-118-m11-flash-card-canonical-fields'));

test.describe('Bug #118 — M11 flash cards use front_en + back_vi', {
  tag: [TAG.regression, TAG.module11, TAG.content, TAG.data, bugTag(118)],
}, () => {
