/**
 * Bug #128 — M12 `flash_card`: canonical `front_en` / `back_vi` / `audio_en`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-128-m12-flash-card-canonical-fields'));

test.describe('Bug #128 — M12 flash cards use front_en + back_vi', {
  tag: [TAG.regression, TAG.module12, TAG.content, TAG.data, bugTag(128)],
}, () => {
