/**
 * Bug #095 — M8 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-095-m8-matching-pairs-nonempty'));

test.describe('Bug #095 — M8 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module8, TAG.content, TAG.data, bugTag(95)],
}, () => {
