/**
 * Bug #059 — M5 `quiz` MCQ structure hygiene.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-059-m5-quiz-options-and-answers'));
...
test.describe('Bug #059 — M5 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module5, TAG.content, TAG.data, bugTag(59)],
}, () => {
