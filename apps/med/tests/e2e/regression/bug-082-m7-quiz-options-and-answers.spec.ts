/**
 * Bug #082 — M7 `quiz` MCQ structure hygiene.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-082-m7-quiz-options-and-answers'));
...
test.describe('Bug #082 — M7 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module7, TAG.content, TAG.data, bugTag(82)],
}, () => {
