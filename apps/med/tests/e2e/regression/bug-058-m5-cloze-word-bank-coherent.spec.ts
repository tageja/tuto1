/**
 * Bug #058 — M5 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m5-deteriorating-escalation-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-058-m5-cloze-word-bank-coherent'));

test.describe('Bug #058 — M5 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module5, TAG.content, TAG.data, bugTag(58)],
}, () => {
