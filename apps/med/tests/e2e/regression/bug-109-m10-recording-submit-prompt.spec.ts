/**
 * Bug #109 — M10 `recording_submit` on L5, L6, L7 (and L8 assessment) must have prompt text.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-109-m10-recording-submit-prompt'));

test.describe('Bug #109 — M10 recording_submit prompting text', {
  tag: [TAG.regression, TAG.module10, TAG.content, TAG.data, bugTag(109)],
}, () => {
