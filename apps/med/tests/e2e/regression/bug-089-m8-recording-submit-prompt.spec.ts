/**
 * Bug #089 — M8 `recording_submit` on L5, L6, L7 (and L8 assessment) must have prompt text.
 */
...
import { loadM8Steps } from '../_shared/m8-documentation-rapid-reporting-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-089-m8-recording-submit-prompt'));

test.describe('Bug #089 — M8 recording_submit prompting text', {
  tag: [TAG.regression, TAG.module8, TAG.content, TAG.data, bugTag(89)],
}, () => {
