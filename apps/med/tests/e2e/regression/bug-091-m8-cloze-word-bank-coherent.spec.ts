/**
 * Bug #091 — M8 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m8-documentation-rapid-reporting-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-091-m8-cloze-word-bank-coherent'));

test.describe('Bug #091 — M8 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module8, TAG.content, TAG.data, bugTag(91)],
}, () => {
