/**
 * Bug #125 — M11 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-125-m11-matching-pairs-nonempty'));

test.describe('Bug #125 — M11 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module11, TAG.content, TAG.data, bugTag(125)],
}, () => {
