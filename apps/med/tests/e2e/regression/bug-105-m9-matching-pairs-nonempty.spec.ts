/**
 * Bug #105 — M9 `matching` pairs: non-empty `left_en` + `right_vi`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-105-m9-matching-pairs-nonempty'));

test.describe('Bug #105 — M9 matching pairs bilingual text', {
  tag: [TAG.regression, TAG.module9, TAG.content, TAG.data, bugTag(105)],
}, () => {
