/**
 * Bug #108 — M10 `flash_card`: canonical `front_en` / `back_vi` / `audio_en`.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-108-m10-flash-card-canonical-fields'));

test.describe('Bug #108 — M10 flash cards use front_en + back_vi', {
  tag: [TAG.regression, TAG.module10, TAG.content, TAG.data, bugTag(108)],
}, () => {
