/**
 * Minor — M2 (Triage Intake) `cloze` steps: bracket blanks non-empty; word bank must
...
test.beforeAll(() => requireSupabaseAdmin('bug-025-m2-cloze-word-bank-coherent'));

test.describe('Bug #025 — M2 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module2, TAG.content, TAG.data, bugTag(25)],
}, () => {
