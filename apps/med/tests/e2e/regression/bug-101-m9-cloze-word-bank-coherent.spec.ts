/**
 * Bug #101 — M9 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m9-simulation-emergency-review-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-101-m9-cloze-word-bank-coherent'));

test.describe('Bug #101 — M9 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module9, TAG.content, TAG.data, bugTag(101)],
}, () => {
