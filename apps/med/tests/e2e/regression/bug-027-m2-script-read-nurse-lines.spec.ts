/**
 * Minor — M2 `script_read`: nurse spoken lines end with "." or "?"; VI line_N aligns with script turns.
 */
...
} from '../_shared/m2-triage-intake-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-027-m2-script-read-nurse-lines'));

test.describe('Bug #027 — M2 script_read nurse line punctuation', {
  tag: [TAG.regression, TAG.module2, TAG.content, TAG.data, bugTag(27)],
}, () => {
