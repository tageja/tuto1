/**
 * Bug #072 — M6 `quiz` MCQ structure hygiene.
 */
...
test.beforeAll(() => requireSupabaseAdmin('bug-072-m6-quiz-options-and-answers'));
...
test.describe('Bug #072 — M6 quiz MCQ structure and answers', {
  tag: [TAG.regression, TAG.module6, TAG.content, TAG.data, bugTag(72)],
}, () => {
