/**
 * Bug #071 — M6 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m6-reassuring-under-pressure-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-071-m6-cloze-word-bank-coherent'));

test.describe('Bug #071 — M6 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module6, TAG.content, TAG.data, bugTag(71)],
}, () => {
