/**
 * Bug #121 — M11 `cloze` steps: bracket blanks + word bank integrity.
 */
...
import {
  ...
  scriptFromConfig,
} from '../_shared/m11-trauma-acute-injuries-linter';

test.beforeAll(() => requireSupabaseAdmin('bug-121-m11-cloze-word-bank-coherent'));

test.describe('Bug #121 — M11 cloze blanks and distractor pool integrity', {
  tag: [TAG.regression, TAG.module11, TAG.content, TAG.data, bugTag(121)],
}, () => {
