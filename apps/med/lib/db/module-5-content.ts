        ...
        },
        {
          ...
          config: {
            ...
            transcriptSegments: [
              ...
              { en: 'Charge Nurse:', vi: 'Điều dưỡng trưởng:' },
              { en: 'I need to report a concern', vi: 'Tôi cần báo cáo một vấn đề' },
              { en: 'Go ahead', vi: 'Nói đi' },
              { en: 'His blood pressure has dropped to 85 over 50', vi: 'Huyết áp của ông ấy đã giảm xuống 85/50' },
              { en: 'His heart rate is up to 115', vi: 'Nhịp tim của ông ấy tăng lên 115' },
              { en: 'He is pale and diaphoretic', vi: 'Ông ấy nhợt nhạt và đổ mồ hôi' },
              { en: 'How long has this been going on?', vi: 'Tình trạng này kéo dài bao lâu rồi?' },
              { en: 'I noticed the change about ten minutes ago', vi: 'Tôi nhận thấy sự thay đổi khoảng mười phút trước' },
              { en: 'He is still conscious but looks very unwell', vi: 'Ông ấy vẫn tỉnh nhưng trông rất yếu' },
              { en: 'Okay', vi: 'Được rồi' },
              { en: 'I am coming now', vi: 'Tôi đang đến ngay' },
              { en: 'Have you called the doctor?', vi: 'Bạn đã gọi bác sĩ chưa?' },
              { en: 'Not yet', vi: 'Chưa' },
              { en: 'I wanted to inform you first', vi: 'Tôi muốn báo cho bạn trước' },
              { en: 'Good', vi: 'Tốt' },
              { en: 'I will call', vi: 'Tôi sẽ gọi' },
              { en: 'Stay with him', vi: 'Ở bên cạnh ông ấy' },
            ],
