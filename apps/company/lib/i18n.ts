...
const vi = {
  ...
  'products.community.desc': 'Mạng xã hội học tập: phụ huynh và giáo viên chia sẻ thành tích, sự kiện và hoạt động của trường, với giao diện quen thuộc như Facebook.',
  ...
  'form.role':          'Bạn là *',
  'form.role.placeholder': 'Chọn vai trò...',
...
const en: typeof vi = {
  ...
  'products.community.desc': 'An education social network: parents and teachers share achievements, events and school news in a familiar Facebook-style interface.',
  ...
  'form.subtitle':      'Leave your details and the Tuto team will get in touch within 24 hours.',
  'form.name':          'Full name *',
  'form.org':           'School / Organisation name *',
  'form.role':          'You are *',
  'form.role.placeholder': 'Select a role...',
